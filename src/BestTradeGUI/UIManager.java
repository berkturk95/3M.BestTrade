...
public class UIManager extends JFrame{
	...
	static LoginPanel loginPanel;
       ...
       /* static ActivationCodeScreen activationCodeScreen;
        ...
        static EditItemPanel editItemPanel;
        static MessageScreen messageScreen;
	static MyProductsPanel myProductsPanel;*/
	...
	public UIManager() throws IOException{
		...
		contentPane.setBorder(new EmptyBorder(100, 100, 1000, 800));
		...
		editItemPanel = new EditItemPanel();
                messageScreen = new MessageScreen();
                myProductsPanel = new MyProductsPanel();
		...
		editItemPanel.setVisible(false);
                ...
                myProductsPanel.setVisible(false);*/
